...
const UpdateComplaintInput = new GraphQLInputObjectType({
    name: "UpdateComplaintInput",
...
const UpdateComplaintPayload = new GraphQLObjectType({
    name: 'UpdateComplaintPayload',
