...
const CreateComplaintInput = new GraphQLInputObjectType({
    name: "CreateComplaintInput",
...
const CreateComplaintPayload = new GraphQLObjectType({
    name: 'CreateComplaintPayload',
